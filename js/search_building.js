(function (factory) {
    ...
    L.Control.Search = L.Control.extend({
      ...
      options: {
        ...
        textPlaceholder: 'Search Buildings, Facilities, or Colleges', // placeholder value
        hideMarkerOnCollapse: false, // remove circle and marker on search control collapsed
        position: 'topleft',
        marker: { // custom L.Marker or false for hide
          icon: true, // custom L.Icon for maker location or false for hide
        ...
        if (this._input.style.display === 'none') { // on first click show _input only
          ...
          if (this._input.value === '') { // hide _input only
            ...
            if (!loc) {
             ...
             // Update the value of the destination text field with the searched POI
              document.getElementById('destination-input').value = this._input.value;
